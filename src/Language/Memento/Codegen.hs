...
import Language.Memento.Syntax (Definition (..), Program (..)) -- Removed ConstructorDef, Type as they are now handled in Definitions.hs
...
finalExecutionBlock :: [Definition] -> Text
